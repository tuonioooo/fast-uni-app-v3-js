...
export const newsList = [
  ...
  '差不多3个小时的等待后，终于等来了警察。一辆警车，闪着警灯，在前头开道。',
  '全球累计新冠肺炎确诊病例510270667例，累计死亡病例6233526例。',
  '话剧《简·爱》经典再启 朱杰濮存昕携手演绎',
  '中国男冰世锦赛乙级A组比赛，先是14比1大胜以色列队，随后5比1战胜荷兰队。',
  '4月份中国制造业采购经理指数（PMI）为47.4%，较上月下降2.1个百分点。',
  '巴斯夫2022年一季度销售额230.83亿欧元，同比增长19%。',
  '长征十一号海射遥三火箭成功发射吉林一号高分卫星，顺利进入预定轨道。',
  '人民日报：团结奋斗，在新征程上创造新的历史伟业',
];

export const catList = Array.from({ length: 5 }, (_, i) => ({
  id: i + 1,
  title: '图片' + (i + 1),
  type: 'ALL',
}));
